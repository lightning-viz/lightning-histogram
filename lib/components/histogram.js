...
var Histogram = React.createClass({displayName: "Histogram",
    ...
    render: function() {
        return (
            React.createElement(AxisWrapper, {width: this.props.width, height: this.props.height, scale: this.scaleX(), ticks: this.state.bins, innerTickSize: 0, onZoomed: this.handleZoom}, 
