...
var Histogram = React.createClass({
    ...
    drawNodes: function() {
        ...
        return _.map(this.state.histData, function(d, i) {
            ...
            return (<Bin x={x} y={y} width={width} height={height} key={i} />)
        }, this);
    },

    render: function() {
        return (
            <AxisWrapper width={this.props.width} height={this.props.height} scale={this.scaleX()} ticks={this.state.bins * 2} innerTickSize={0}>
                <Canvas>
                    {this.drawNodes()}
                </Canvas>
            </AxisWrapper>
